...
def _build_pdf_html(payload):
    ...
    footer_right_text = esc(footer_right) if footer_right else ""
    footer_ts = f"<span style='font-size:10pt;color:#bbb'>{esc(_ts)}</span>"
    footer_right_html = (footer_right_text + "<br>" + footer_ts) if footer_right_text else footer_ts
    bank_html = ""
    ...
    css = (
        ...
        "@page{size:420mm 594mm;margin:12mm 20mm}@page :first{margin:0}*{-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important;color-adjust:exact!important}"
        ...
        ".header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:20mm;padding-bottom:16mm;border-bottom:2pt solid #000}"
        ".logo{height:160pt;object-fit:contain;display:block;margin-bottom:12pt}"
        ".company-block{font-size:18pt;color:#000;line-height:1.85}"
        ".company-name{font-weight:bold;color:#000;font-size:20pt;display:block;margin-bottom:2pt}"
        ".doc-type{font-size:56pt;letter-spacing:8pt;text-transform:uppercase;color:#000;line-height:1;text-align:right}"
        ".doc-number{font-size:14pt;color:#333;margin-top:12pt;letter-spacing:2pt;text-transform:uppercase;text-align:right}"
        ".meta-row{display:flex;gap:16mm;margin-bottom:16mm;align-items:flex-start}"
        ".bill-to{flex:1}"
        ".party-label{font-size:13pt;font-weight:bold;letter-spacing:4pt;text-transform:uppercase;color:#333;margin-bottom:12pt}"
        ".party-name{font-size:26pt;font-weight:bold;color:#000;margin-bottom:8pt}"
        ".party-detail{font-size:17pt;color:#000;line-height:1.9}"
        ".dates-box{flex:1.4;border:2pt solid #000;display:flex}"
        ".date-item{flex:1;padding:16pt 24pt;border-right:2pt solid #000}"
        ".date-item:last-child{border-right:none}"
        ".date-label{font-size:13pt;font-weight:bold;letter-spacing:3pt;text-transform:uppercase;color:#333;margin-bottom:8pt}"
        ".date-value{font-size:22pt;font-weight:bold;color:#000}"
        "table{width:100%;border-collapse:collapse;margin-bottom:12mm}"
        "thead tr{border-top:2pt solid #000;border-bottom:2pt solid #000}"
        "thead th{padding:12pt 18pt;font-size:13pt;font-weight:bold;letter-spacing:3pt;text-transform:uppercase;color:#000;text-align:left}"
        "thead th:nth-child(2),thead th:nth-child(3){text-align:center}"
        "thead th:last-child{text-align:right}"
        "tbody tr{border-bottom:1pt solid #ccc}"
        "tbody td{padding:18pt 18pt;font-size:18pt;color:#000;vertical-align:top;line-height:1.6}"
        "tbody td:nth-child(2),tbody td:nth-child(3){text-align:center;color:#333}"
        "tbody td:last-child{text-align:right;font-weight:bold;white-space:nowrap}"
        ".item-title{font-weight:bold;color:#000;font-size:17pt;display:block;margin-bottom:6pt}"
        ".item-detail{font-size:14pt;color:#333;line-height:1.75;display:block}"
        ".totals-wrap{display:flex;justify-content:flex-end;margin-bottom:16mm}"
        ".totals{width:120mm}"
        ".total-row{display:flex;justify-content:space-between;padding:8pt 0;font-size:16pt;color:#333;border-bottom:1pt solid #ccc}"
        ...
        ".section-title{font-size:13pt;font-weight:bold;letter-spacing:4pt;text-transform:uppercase;color:#333;margin-bottom:14pt;padding-bottom:10pt;border-bottom:1pt solid #999}"
        ".bank-detail{font-size:16pt;color:#000;line-height:2}"
        ".terms-text{font-size:15pt;font-weight:bold;color:#000;line-height:1.85}"
        ".footer{position:absolute;bottom:20mm;left:32mm;right:32mm;border-top:1pt solid #999;padding-top:12pt;display:flex;justify-content:space-between}"
        ".footer-brand{font-size:13pt;color:#666;letter-spacing:3pt;text-transform:uppercase}"
