...
def _build_pdf_html(payload):
    ...
    css = (
        ...
        ".header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:10mm;padding-bottom:8mm;border-bottom:1pt solid #000}"
        ".logo{height:52pt;object-fit:contain;display:block;margin-bottom:6pt}"
        ".company-block{font-size:9pt;color:#000;line-height:1.85}"
        ...
        ".doc-number{font-size:7pt;color:#333;margin-top:6pt;letter-spacing:1pt;text-transform:uppercase;text-align:right}"
        ".meta-row{display:flex;gap:8mm;margin-bottom:8mm;align-items:flex-start}"
        ".bill-to{flex:1}"
        ".party-label{font-size:6.5pt;font-weight:bold;letter-spacing:2pt;text-transform:uppercase;color:#333;margin-bottom:6pt}"
        ".party-name{font-size:13pt;font-weight:bold;color:#000;margin-bottom:4pt}"
        ".party-detail{font-size:8.5pt;color:#000;line-height:1.9}"
        ".dates-box{flex:1.4;border:1pt solid #000;display:flex}"
        ".date-item{flex:1;padding:8pt 12pt;border-right:1pt solid #000}"
        ".date-item:last-child{border-right:none}"
        ".date-label{font-size:6.5pt;font-weight:bold;letter-spacing:1.5pt;text-transform:uppercase;color:#333;margin-bottom:4pt}"
        ".date-value{font-size:11pt;font-weight:bold;color:#000}"
        "table{width:100%;border-collapse:collapse;margin-bottom:6mm}"
        "thead tr{border-top:1pt solid #000;border-bottom:1pt solid #000}"
        ...
        "tbody tr{border-bottom:0.5pt solid #ccc}"
        "tbody td{padding:9pt 9pt;font-size:9pt;color:#000;vertical-align:top;line-height:1.6}"
        ...
        ".item-detail{font-size:7pt;color:#333;line-height:1.75;display:block}"
        ".totals-wrap{display:flex;justify-content:flex-end;margin-bottom:8mm}"
        ".totals{width:60mm}"
        ".total-row{display:flex;justify-content:space-between;padding:4pt 0;font-size:8pt;color:#333;border-bottom:0.5pt solid #ccc}"
        ".total-row.discount{color:#c00}"
        ".total-final{display:flex;justify-content:space-between;align-items:baseline;padding:9pt 0 0;margin-top:4pt;border-top:1pt solid #000}"
        ...
        ".section-title{font-size:6.5pt;font-weight:bold;letter-spacing:2pt;text-transform:uppercase;color:#333;margin-bottom:7pt;padding-bottom:5pt;border-bottom:0.5pt solid #999}"
        ".bank-detail{font-size:8pt;color:#000;line-height:2}"
        ".terms-text{font-size:7.5pt;font-weight:bold;color:#000;line-height:1.85}"
        ".footer{position:absolute;bottom:10mm;left:16mm;right:16mm;border-top:0.5pt solid #999;padding-top:6pt;display:flex;justify-content:space-between}"
        ".footer-brand{font-size:6.5pt;color:#666;letter-spacing:1.5pt;text-transform:uppercase}"
        ".footer-right{font-size:6.5pt;color:#666;font-style:italic}"
    )
